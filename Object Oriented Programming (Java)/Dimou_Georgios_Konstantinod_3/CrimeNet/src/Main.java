...
public class Main {
	...
	public static void main(String[] args) {
		...
		FindSuspect_GUI gui = new FindSuspect_GUI(registry.getaSus());
		//ErrorMessage err = new ErrorMessage(s1);
		 ...
		 * System.out.println("Test1: " + topSuspect.getName() + ", " +
		 * topSuspect.getCodeName()); System.out.println();
		 * 
		 * //Test 2. Longest Phone Call Between PhoneCall longestCall =
		 * registry.getLongestPhoneCallBetween("00496955444444", "00478484777777");
		 * System.out.println("Test2: "); longestCall.printInfo(); System.out.println();
		 * 
		 * //Test 3. get Suspicious Messages Between ArrayList<SMS> listOfMessages =
		 * registry.getMessagesBetween("00478484777777", "00446999888888");
		 * System.out.println("Test3: "); for(SMS sms: listOfMessages) sms.printInfo();
		 * System.out.println();
		 * 
		 * //Test 4. check whether suspects are connected System.out.println("Test4: ");
		 * System.out.println(s1.isConnectedTo(s3));
		 * System.out.println(s3.isConnectedTo(s2)); System.out.println();
		 * 
		 * //Test 5. get List of common partners System.out.println("Test5: ");
		 * ArrayList<Suspect> commonSuspects = s1.getCommonPartners(s3); for(Suspect
		 * suspect: commonSuspects) System.out.println(suspect.getName() + ", " +
		 * suspect.getCodeName()); System.out.println();
		 * 
		 * //Test 6. get List of Suggested partners System.out.println("Test6: ");
		 * ArrayList<Suspect> suggestedSuspects = s1.suggestedSupects(s3); for(Suspect
		 * suspect: suggestedSuspects) System.out.println(suspect.getName() + ", " +
		 * suspect.getCodeName()); System.out.println();
		 */
