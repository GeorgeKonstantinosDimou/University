...
calculateSales(SALESMAN,PRODUCTS,sales,price,salePerson);
calculateProductSales(SALESMAN,PRODUCTS,sales,productSale);
maxArray(SALESMAN,salePerson,&income,&MaxSalesMan);
maxArray(PRODUCTS,productSale,&items,&MaxProduct);

printArray(SALESMAN,salePerson);
